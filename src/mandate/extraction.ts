...
const ExtractionOutput = z.object({
  ...
  segment: z.enum(['senior_executive', 'senior_it_consultant']),
...
Segment: "senior_executive" for director level and above with organizational scope;
"senior_it_consultant" for architects, principal engineers and senior project specialists,
including contract and consulting engagements.
...
Return JSON with exactly these keys: title, segment, functionDomain, location, engagementType,
firstYearOutcomes, operatingRange, careerMoveCase, titleVariants, mustHaveSkills, exclusions,
targetCompanies.
